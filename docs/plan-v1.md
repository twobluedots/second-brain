# Second Brain MVP Plan — v1 (archived)

> **🔒 FROZEN — v1 (MVP) record.** The plan for v1: capture → categorize → ask (M1–M4). Shipped.
> Current work: [plan.md](plan.md). Direction across versions: [roadmap.md](roadmap.md). Eval/learning: [learning.md](learning.md).
> Do not edit — this is the v1 archive.
...
- [x] **M4.1 — Use it every day for a week** (ongoing)
...
- [x] **M4.2 — Fix the top 3 annoyances** (~3 hrs)
...
- [x] **M4.5 — Push to GitHub** (~30 min)
  - Create repo
  - Push code
  - This is the goal. Don't overthink it. Push.

- [x] **M4.6 — Share with 1-2 friends** (~30 min)
...
**Risk:** Perfectionism on the README or repo structure.
---
